...
%   João Filipe Henriques, 2010
    ...
    if nargin < 6 || isempty(size_video), size_video = [0 0.03 1 0.97]; end %default video window size within the open window (set same as the original videofig) HO 2/17/2011
