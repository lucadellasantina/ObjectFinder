...
sholl.intersections = tmpShollRadius;

% Store maximum number of intersections reached and radius of that max
[tmpMax, tmpIdx] = max(tmpShollRadius(:,2));
sholl.criticalValue = tmpMax;
sholl.dendriteMaximum = tmpShollRadius(tmpIdx,2);
end

function [xp, yp] = circle(x,y,r)
%% x and y are the coordinates of the center of the circle
% r is the radius of the circle 0.01 is the angle step, 
% bigger values will draw the circle faster but
...
%% Calculate Intersections of curves.
