...
<ol>
  <li>Install ObjectFinder using MATLAB "Install App" button</li>
  <li>Start ObjectFinder from your Apps list.</li>
  ...
  <li>Click "Load Images", the available images will be displayed as x-y projection and you will be asked to tell ObjectFinder which image contains the structures to recognize. Optionally, you can also specify which image contains a binary mask to limit the search.</li>
...
ObjectFinder is developed and maintained by <a href="https://github.com/lucadellasantina">Luca Della Santina</a>. It builds on ideas initially developed in the <a href="http://wonglab.biostr.washington.edu">Wong Lab</a> at the University of Washington in Seattle.
